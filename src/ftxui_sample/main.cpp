...
// configuration step. It creates a namespace called `clunk_24`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", clunk_24::cmake::project_name, clunk_24::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", clunk_24::cmake::project_version);
      return EXIT_SUCCESS;
    }
